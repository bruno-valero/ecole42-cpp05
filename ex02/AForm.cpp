...
AForm::AForm(void): _name("aform_default"), _is_signed(false), _min_grade_to_sign(3), _min_grade_to_execute(2) {};
AForm::AForm(const std::string &name, int grade_to_sign, int grade_to_execute): _name(name), _is_signed(false), _min_grade_to_sign(grade_to_sign), _min_grade_to_execute(grade_to_execute)
{
